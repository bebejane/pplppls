...
const TimeStretcher = function(buffer, options){
...
TimeStretcher.prototype = {
  init: function(options) {
    this.options = {
      ...
      stretchFactor: 1.0,       // Stretch factor (1.5x)
  ...
  stretch: function() {
    ...
    console.log("Starting time stretch ("+ (stretch_amount) +"x). Buffer size: " + length);
    ...
    console.log("Analysis complete: " + frames_processed + " frames.")
