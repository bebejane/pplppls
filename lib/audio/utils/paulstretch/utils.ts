...
export const createWindow = function(winSize) {
...
export const applyWindow = function(block, winArray) {
...
export const makeRephaser = function(winSize) {
...
export const Samples = function(displacePos) {
  var blocksIn = []
  ...
  this.write = function(block) {
    //console.log('write', block[0].length)
    blocksIn.push(block)
